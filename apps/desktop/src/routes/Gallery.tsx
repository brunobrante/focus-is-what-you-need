...
export function ProjectEditPanel({
  ...
  return (
    <div
      className="flex flex-1 flex-col bg-[var(--bg)]"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      ...
      {/* Body */}
      <div className="flex flex-1 gap-0 md:grid md:grid-cols-[260px_1fr]">
        {/* Left: Icon picker */}
        <div className="flex flex-col gap-5 border-b border-[var(--border)] px-7 py-7 md:border-b-0 md:border-r">
