...
import { createElementForTool, reparentElements, shallowCloneDocument } from "@/lib/editor/actions";
import { getDescendantIds, roundPixel } from "@/lib/editor/geometry";
import type { CanvasDocument, EditorState, Point, Rect } from "@/lib/editor/types";
import type { EditorAction } from "@/lib/editor/store";
import { clampViewportState } from "@/lib/editor/viewport";
...
import { findElementsInMarquee, getCanvasSize } from "./canvasStageUtils";
