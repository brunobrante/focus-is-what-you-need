...
import type { EditorState, Point, ResizeHandle } from "@/lib/editor/types";
import { getCanvasDisplayScale } from "@/lib/editor/viewport";
...
export function startResizeInteraction(
  ...
  const startRects: Record<string, import("@/lib/editor/types").Rect> = {};
