...
import type { CanvasDocument, EditorState, Point } from "@/lib/editor/types";
import type { Size } from "@/lib/editor/viewport";
import { buildViewportTransform, clearNativeTextSelection, textIndexFromClientPoint } from "../canvasStageHelpers";
