...
import type { EditorState, Point } from "@/lib/editor/types";
import type { EditorAction } from "@/lib/editor/store";
import type { CanvasDocument } from "@/lib/editor/types";
import { buildViewportTransform, selectionRangeFromAnchor, clearNativeTextSelection, isClientPointInsideTextContent, isClientPointInsideTextNode, textIndexFromClientPoint } from "../canvasStageHelpers";
