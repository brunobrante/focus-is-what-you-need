...
import {
  ...
  type Tab,
  uid,
} from "@/application/system-design/useSystemDesign";
    ...
    <div className="flex h-screen flex-col bg-[var(--bg)]">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <SystemDesignManager
          ...
          setNewDesignName={setNewDesignName}
...
type SystemDesignManagerProps = {
  activeWorkspaceId: string | null;
  designs: Array<{ id: string; name: string; shared: boolean; libraries: { id: string; name: string }[]; icons: { id: string; name: string }[] }>;
  selectedId: string | null;
  setSelectedId: (id: string | null) => void;
  selected: { id: string; name: string; shared: boolean; libraries: { id: string; name: string }[]; icons: { id: string; name: string }[] } | null;
